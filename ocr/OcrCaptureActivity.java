...
public final class OcrCaptureActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (extras != null && extras.getString("preferences") != null) {
            preferences = extras.getString("preferences");
        } else {
            preferences = "0000000000"; // default preferences if none provided
        }
        ...
        takePicture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SparseArray<TextBlock> items = (detectorProcessor != null) ? detectorProcessor.getDetectedList() : null;
                ...
                if (items != null) {
                    ...
                    // If OCR returned no usable text, notify and stay on scanner
                    if (itemList.isEmpty()) {
                        Toast.makeText(OcrCaptureActivity.this, "No text detected", Toast.LENGTH_SHORT).show();
                        return;
                    }
                } else {
                    Toast.makeText(OcrCaptureActivity.this, "No text detected yet", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        mCameraSource =
                new CameraSource.Builder(getApplicationContext(), textRecognizer)
                        ...
                        // Use a common 16:9 preview size to reduce stretching/cropping
                        .setRequestedPreviewSize(1280, 720)
                        // Increase FPS for smoother preview/detection
